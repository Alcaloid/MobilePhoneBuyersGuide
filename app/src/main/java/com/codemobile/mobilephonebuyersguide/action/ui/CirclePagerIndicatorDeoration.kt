package com.codemobile.mobilephonebuyersguide.action.ui
...
class CirclePagerIndicatorDecoration : RecyclerView.ItemDecoration() {
    ...
    private val colorActive = Color.parseColor("#6600FF")
    private val colorInactive = Color.parseColor("#CCCCCC")
